...
modMask' = mod4Mask
-- Define workspaces
myWorkspaces    = ["1:main","2:web","3:vim","4:chat","5:music","6:misc"]
-- Dzen/Conky
myXmonadBar = "dzen2 -x '0' -y '0' -h '24' -w '1920' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"
myStatusBar = "conky -c /home/cr0c0/.xmonad/.conky_dzen | dzen2 -x '0' -w '3820' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/cr0c0/.xmonad/dzen2"
--}}}
-- Main {{{ 
main = do
...
manageHook' = (composeAll . concat $
    ...
    where
        ...
        myDev	  = ["xfce4-terminal --hide-menubar"]
        myVim	  = ["vim"]
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,                    xK_r        ), spawn "xscreensaver-command -lock")
    ]
    ++
